...
| Six-week visitor follow-up | Complete for controlled pilot | Consent-gated event stream, shared queue, six deterministic staff tasks, owner/status/outcome commands, backend-verified administrator override, and synthetic acceptance; no outbound automation. |
