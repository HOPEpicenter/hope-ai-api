...
- [ ] Lock “Engagement event envelope v1” in one place (validate + normalize consistently).
- [ ] Lock “Timeline read contract v1” (cursor paging, stable ordering, consistent limits).
