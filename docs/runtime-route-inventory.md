...
| PATCH | `/api/staff-identities/{staffId}` | Update, rebind, deactivate, or reactivate Staff Identity through immutable events | `HOPE_ADMIN_API_KEY` + active configured canonical administrator |
